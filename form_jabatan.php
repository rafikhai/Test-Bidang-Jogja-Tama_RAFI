...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <br><br><br><br><br><br>
            <div class="container">
        <form method="POST" action="input_jabatan.php">
        ...
        <!--Lihat Data-->
        <section class="project-section bg-black" id="output_jabatan">
            <br><br><br>
        <center>
        <a href="output_jabatan.php"><button type="button" class="btn btn-light rounded-pill btn-lg btn-outline-dark">Lihat Data Jabatan</button></a>
        </center>
        <br><br><br>
        </section>
