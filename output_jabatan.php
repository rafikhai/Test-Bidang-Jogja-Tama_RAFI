...
<html lang="en">
        ...
        <header class="masthead">
            ...
            <div class="container">
                ...
                <table class="table table-hover rounded"> 
                    ...
                    <?php 
                    include 'koneksi.php'; 
                    $query=mysqli_query($konek,"select * from jabatan_pegawai"); while($data=mysqli_fetch_array($query)) 
                    { ?> 
                        <tr>
                            <td> <?php echo $data['id_jabatan']; ?></td> 
                            <td> <?php echo $data['nama_jabatan']; ?></td> 
                            <td> 
                                <a href=edit_jabatan.php?id_jabatan=<?php echo $data['id_jabatan'];?>>Edit</a>
                                <a href=hapus_jabatan.php?id_jabatan=<?php echo $data['id_jabatan'];?>>Hapus</a>
                            </td>
                            <?php 
                                }
                            ?>
  ...
  <!--Data Pegawai-->
  <section class="project-section bg-black" id="form-pegawai">
          
          <center>
          <a href="form_jabatan.php"><button type="button" class="btn btn-light rounded-pill btn-lg btn-outline-dark">Form Jabatan</button></a>
          <br>
