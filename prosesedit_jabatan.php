...
<html lang="en">
    <head>
        ...
        <header class="masthead">
            ...
            $query=mysqli_query($konek,"UPDATE jabatan_pegawai SET id_jabatan='$id_jabatan', nama_jabatan='$nama_jabatan' where id_jabatan='$id_jabatan'");
        ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-center tulisan2">
                    <?php
                        if($query)
                        {
                            echo "Proses Edit berhasil, ingin lihat hasil <a href ='output_jabatan.php'><mark>di sini</mark></a>";
                        }
                        else
                        {
        ...
        <!-- Footer-->
        <footer class="footer bg-black small text-center text-white-50"><div class="container">Copyright © Jogja Tama IT Team 2024</div></footer>
        <!-- Bootstrap core JS-->
