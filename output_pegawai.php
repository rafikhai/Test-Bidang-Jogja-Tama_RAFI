                ...
                <table class="table table-hover rounded"> 
                    <thead>
                        <tr>
                            ...
                            <th scope="col"> Tanggal tanggal_lahir </th>
                    ...
                    <?php 
                    include 'koneksi.php'; 
                    $query=mysqli_query($konek,"select * from pegawai"); while($data=mysqli_fetch_array($query)) 
                    { ?> 
                        <tr>
                            ...
                            <td> 
                                ...
                                <a href=hapus_pegawai.php?id_pegawai=<?php echo $data['id_pegawai'];?>>Hapus</a>
                            </td>
                            <?php 
                                }
                            ?>
...
<section class="project-section bg-black" id="form-pegawai">
        ...
        <center>
        <a href="form_pegawai.php"><button type="button" class="btn btn-light rounded-pill btn-lg btn-outline-dark">form Pegawai</button></a>
        <br>
