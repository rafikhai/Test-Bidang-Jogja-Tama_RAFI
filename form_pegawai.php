    ...
    <body id="page-top">
        ...
        <form method="POST" action="input_pegawai.php">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Pegawai">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="gaji" placeholder="Masukan Gaji">
                </div>
            </div>
        ...
        <!--Lihat Data-->
        <section class="project-section bg-black" id="output_pegawai">
            <br><br><br>
        <center>
        <a href="output_pegawai.php"><button type="button" class="btn btn-light rounded-pill btn-lg btn-outline-dark">Lihat Data Pegawai</button></a>
        </center>
        <br><br><br>
        </section>
